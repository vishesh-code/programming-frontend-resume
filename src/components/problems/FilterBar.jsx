...
const FilterBar = ({
  ...
  solvedFilter,
  setSolvedFilter,
  // Removed darkMode from props since we will get it from context
}) => {
  const { darkMode } = useTheme(); // <-- GET DARK MODE DIRECTLY FROM CONTEXT
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          >
            <option value="All">All Status</option>
            <option value="Solved">Completed</option>
            <option value="Unsolved">Todo</option> {/* Updated value to match Landing.jsx logic */}
          </select>
        </div>
      </div>
    </div>
